...
const MarksButton = class {
    ...
    render() {
        return (index.h("button", { class: `btn ${this.appearance}`, type: "button", disabled: this.loader }, this.text, this.loader ? index.h("marks-spinner", { type: "circle", color: "green" }) : index.h("div", null)));
    }
};
...
const MarksIntegration = class {
    ...
    render() {
        return (index.h(index.Host, null, index.h("h2", null, "My first integration"), "Loading? ", this.isLoading ? "yes" : "no", this.isLoading ?
            index.h("marks-button", { text: "Requesting...", color: "secondary", loader: true })
            :
                index.h("marks-button", { onClick: this.handleNewDriver, text: "Request new driver", appearance: "primary" }), this.data ? index.h("p", null, "Created: ", this.data.createdDriver) : index.h("p", null, "Request new driver now!"), "Loading? ", this.isLoading ? "yes" : "no", this.isLoading ?
            index.h("marks-button", { text: "Requesting...", color: "secondary", loader: true })
            :
                index.h("marks-button", { onClick: this.handleGetDrivers, text: "Request all drivers", appearance: "warning" }), index.h("p", null, "All Drivers:"), index.h("ol", null, this.drivers.map((driver) => index.h("li", null, driver))), "Loading? ", this.isLoading ? "yes" : "no", this.isLoading ?
            index.h("marks-button", { text: "Requesting...", color: "secondary", loader: true })
            :
                index.h("marks-button", { onClick: this.handleDeleteDrivers, text: "Delete all drivers", appearance: "danger" }), index.h("slot", null)));
    }
};
...
const MarksModal = class {
    ...
    render() {
        return (index.h("div", { class: this.isopen ? 'modal-wrapper isopen' : 'modal-wrapper' }, index.h("div", { class: "modal-overlay", onClick: this.handleCancel }), index.h("div", { class: "modal" }, index.h("div", { class: "header" }, index.h("h6", null, this.header), index.h("div", { class: "close", onClick: this.handleCancel }, index.h("img", { src: index.getAssetPath(`./assets/${this.closeIcon}`), alt: "close icon" }))), index.h("div", { class: "body" }, index.h("slot", null)), index.h("div", { class: "footer" }, this._buttons.map((button, index$1) => (index.h("marks-button", { onClick: index$1 === 0 ? this.handleAction : this.handleCancel, text: button.text, appearance: index$1 === 0 && this.appearance })))))));
    }
...
const MarksSpinner = class {
    ...
    render() {
        switch (this.type) {
            case 'circle':
                return (index.h("img", { src: index.getAssetPath("./assets/12-dots-scale-rotate.svg"), alt: "circle icon" }));
            case 'bars':
                return (index.h("img", { src: index.getAssetPath("./assets/tadpole.svg"), alt: "bars icon" }));
            case 'android':
                return (index.h("img", { src: index.getAssetPath("./assets/wifi.svg"), alt: "bars icon" }));
            case 'ios':
                return (index.h("img", { src: index.getAssetPath("./assets/wind-toy.svg"), alt: "bars icon" }));
            default:
                return (null);
        }
    }
...
const MyComponent = class {
    ...
    render() {
        return (index.h("div", null, index.h("p", null, "Hello, World! I'm ", this.getText()), index.h("h3", null, "Enjoy this bible passage below"), index.h("div", null, "Loading? ", this.isLoading ? "yes" : "no", this.isLoading ?
            index.h("marks-button", { text: "Requesting...", color: "secondary", loader: true })
            :
                index.h("marks-button", { onClick: this.handleAction, text: "Request new passage", appearance: "primary" })), index.h("h4", null, this.data && this.verseRef), index.h("p", null, index.h("span", { innerHTML: this.verse }))));
    }
};
MyComponent.style = myComponentCss;

exports.marks_button = MarksButton;
exports.marks_integration = MarksIntegration;
exports.marks_modal = MarksModal;
exports.marks_spinner = MarksSpinner;
exports.my_component = MyComponent;

//# sourceMappingURL=marks-button_5.cjs.entry.js.map